...
@FeignClient(name = "domesticClient", url = "https://finopenapi.ssafy.io/ssafy/api/v1/edu/demandDeposit")
public interface DomesticClient {
    ...
    UpdateTranferLimitResponseDTO updateTransferLimit(@RequestBody UpdateTransferLimitRequestDTO requestDTO);
